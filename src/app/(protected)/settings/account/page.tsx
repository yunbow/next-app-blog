      ...
      <div className="space-y-6">
        ...
        <Card className="border-destructive/50">
          <CardHeader>
            ...
            <CardDescription>
              アカウントを削除すると、すべてのデータ（記事、コメント、ブックマーク等）が完全に削除されます。この操作は取り消せません。
            </CardDescription>
          </CardHeader>
          <CardContent>
            {!showDeleteConfirm ? (
              ...
              <div className="space-y-4">
                <div className="p-4 bg-destructive/10 border border-destructive/30 rounded-md">
                  ...
                  <p className="text-sm text-muted-foreground">
                    確認のため、「<span className="font-semibold text-foreground">{confirmText}</span>」と入力してください。
                  </p>
                </div>
                ...
                <div className="flex gap-3">
                  <Button
                    ...
                    disabled={deleteInput !== confirmText || isDeleting}
                  >
