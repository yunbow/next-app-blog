...
export const en: Translations = {
  ...
  settings: {
    ...
    subscriptionDescription: "Current plan and billing information",
    billing: "Plan & Billing",
    currentPlan: "Current Plan",
    planFree: "Free",
    planBasic: "Basic",
    planPremium: "Premium",
    planBasicDescription: "Standard plan with access to all core features",
    planPremiumDescription: "Premium plan with unlimited access to all features",
    switchPlan: "Switch to this plan",
    cancelSubscription: "Cancel subscription",
    cancelConfirm: "Are you sure you want to cancel? Your subscription will end at the current period end.",
    currentPlanBadge: "Current plan",
    renewsOn: "Renews on {date}",
    cancelsOn: "Cancels on {date}",
    switchSuccess: "Plan switched successfully",
