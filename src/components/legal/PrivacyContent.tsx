    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <section className="mt-6" aria-labelledby="privacy-ja-1">
          ...
          <p>
            Blog（以下「本サービス」といいます）の運営者（以下「運営者」といいます）は、
    ...
    <Card>
      ...
      <CardContent className="prose dark:prose-invert max-w-none">
        ...
        <section className="mt-6" aria-labelledby="privacy-en-1">
          ...
          <p>
            The operator (hereinafter referred to as &quot;Operator&quot;) of Blog (hereinafter referred to as &quot;Service&quot;)
        ...
        <section className="mt-6" aria-labelledby="privacy-en-2">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Posted content (text, images, etc.)</li>
          </ul>
