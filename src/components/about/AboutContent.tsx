    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          <section>
            <h2 className="text-xl font-semibold mb-4">{t("about.authorName")}</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-primary hover:underline"
                  aria-label={t("accessibility.opensInNewTab", { name: "GitHub" })}
                >
                  GitHub
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                  aria-label={t("accessibility.opensInNewTab", { name: "Qiita" })}
                >
                  Qiita
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                  aria-label={t("accessibility.opensInNewTab", { name: "Zenn" })}
                >
                  Zenn
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                  aria-label={t("accessibility.opensInNewTab", { name: "X (Twitter)" })}
                >
                  X (Twitter)
                </a>
              </div>
          ...
          <section className="mt-8 pt-6 border-t">
            <h3 className="text-lg font-semibold mb-3">{t("about.serviceTitle")}</h3>
